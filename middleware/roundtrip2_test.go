...
func testHttpLog(traffic string, start time.Time, duration time.Duration, req *http.Request, resp *http.Response, routeName string, timeout int, limit rate.Limit, burst int, rateThreshold, proxy, proxyThreshold, statusFlags string) {
...
func init() {
	...
	controller.EgressTable().AddController(controller.NewRoute(retryRoute, controller.EgressTraffic, "", false, controller.NewTimeoutConfig(true, 504, time.Millisecond)))
...
func Example_Controller_Default() {
	...
	//Output:
	//test: Write() -> [{"traffic":"egress","route-name":"*","method":"GET","host":"www.google.com","path":"","protocol":"HTTP/1.1","status-code":200,"status-flags":"","bytes-received":-1,"bytes-sent":0,"timeout-ms":-1,"rate-limit":-1,"rate-burst":-1,"rate-threshold":,"proxy":,"proxy-threshold":}]
...
func Example_Controller_Default_Timeout() {
	...
	//Output:
	//test: Write() -> [{"traffic":"egress","route-name":"timeout-route","method":"GET","host":"www.google.com","path":"/search","protocol":"HTTP/1.1","status-code":504,"status-flags":"UT","bytes-received":-1,"bytes-sent":0,"timeout-ms":1,"rate-limit":-1,"rate-burst":-1,"rate-threshold":,"proxy":,"proxy-threshold":}]
	//test: RoundTrip(handler:true) -> [status_code:504] [err:<nil>]

}

func _Example_Controller_Default_RateLimit() {
	...
	//Output:
	//test: Write() -> [{"traffic":"egress","route-name":"rate-limit-route","method":"GET","host":"www.twitter.com","path":"","protocol":"HTTP/1.1","status-code":301,"status-flags":"","bytes-received":-1,"bytes-sent":0,"timeout-ms":-1,"rate-limit":2000,"rate-burst":10,"rate-threshold":95/500ms,"proxy":,"proxy-threshold":}]
	//test: Write() -> [{"traffic":"egress","route-name":"*","method":"GET","host":"","path":"/","protocol":"","status-code":200,"status-flags":"","bytes-received":-1,"bytes-sent":0,"timeout-ms":-1,"rate-limit":-1,"rate-burst":-1,"rate-threshold":,"proxy":,"proxy-threshold":}]
	//test: RoundTrip(handler:true) -> [status_code:200] [err:<nil>]
...
func Example_Controller_Default_Retry_NotEnabled() {
	...
	//Output:
	//test: Write() -> [{"traffic":"egress","route-name":"retry-route","method":"GET","host":"www.facebook.com","path":"","protocol":"HTTP/1.1","status-code":504,"status-flags":"UT","bytes-received":-1,"bytes-sent":0,"timeout-ms":1,"rate-limit":-1,"rate-burst":-1,"rate-threshold":,"proxy":,"proxy-threshold":}]
	//test: RoundTrip(handler:true) -> [status_code:504] [err:<nil>]
...
func Example_Controller_Default_Retry_RateLimited() {
	...
	//Output:
	//test: Write() -> [{"traffic":"egress","route-name":"retry-route","method":"GET","host":"www.facebook.com","path":"","protocol":"HTTP/1.1","status-code":504,"status-flags":"RT-RL","bytes-received":-1,"bytes-sent":0,"timeout-ms":1,"rate-limit":0,"rate-burst":0,"rate-threshold":,"proxy":,"proxy-threshold":}]
	//test: RoundTrip(handler:true) -> [status_code:504] [err:<nil>]
...
func Example_Controller_Proxy() {
	...
	//Output:
	//test: Write() -> [{"traffic":"egress","route-name":"proxy-route","method":"GET","host":"www.google.com","path":"/search","protocol":"HTTP/1.1","status-code":200,"status-flags":"","bytes-received":-1,"bytes-sent":0,"timeout-ms":-1,"rate-limit":-1,"rate-burst":-1,"rate-threshold":,"proxy":true,"proxy-threshold":10}]
	//test: RoundTrip(handler:true) -> [status_code:200] [err:<nil>]
