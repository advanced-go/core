...
type HttpAccessLogFn func(traffic string, start time.Time, duration time.Duration, r *http.Request, response *http.Response, controllerName string, limit rate.Limit, burst int, timeout int, statusFlags string)
