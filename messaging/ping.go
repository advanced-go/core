...
func Ping[E runtime.ErrorHandler](ctx context.Context, uri string) (status runtime.Status) {
	return ping[E](HostExchange, ctx, uri)
}

func ping[E runtime.ErrorHandler](ex Exchange, ctx context.Context, uri string) (status runtime.Status) {
	var e E
	...
	msg := Message{To: uri, From: PkgPath, Event: PingEvent, Status: nil, ReplyTo: NewMessageCacheHandler[E](cache)}
