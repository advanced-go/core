...
func ExampleNewStatusError() {
	s := NewStatusError(http.StatusBadRequest, errors.New("bad request error"), "ExampleNewStatusError()")
	...
	//{ "code":400, "status":"Bad Request", "request-id":"123-45-678", "errors" : [ "bad request error" ], "trace" : [ "","ExampleNewStatusError()" ] }
