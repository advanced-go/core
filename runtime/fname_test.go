...
func Example_FileNameError() {
	//s := "file://[cwd]/runtimetest/test-response.html"
	//u, err := url.Parse(s)
	...
	//test: FileName(file://[cwd]/runtimetest/test-response.html) -> [type:*http.Request] [url:error: invalid URL type: *http.Request]
...
func Example_FileName() {
	...
	s = "file:///c:/Users/markb/GitHub/core/runtime/runtimetest/test-response.html"
	name = FileName(s)
	fmt.Printf("test: FileName(%v) -> [type:%v] [url:%v]\n", s, reflect.TypeOf(s), name)
	...
	//Output:
	//test: url.Parse(file://[cwd]/runtimetest/test-response.html) -> [err:<nil>]
	//test: FileName(file://[cwd]/runtimetest/test-response.html) -> [type:string] [url:C:\Users\markb\GitHub\core\runtime\runtimetest\test-response.html]
	//test: FileName(file://[cwd]/runtimetest/test-response.html) -> [type:*url.URL] [url:C:\Users\markb\GitHub\core\runtime\runtimetest\test-response.html]
	//test: FileName(file:///c:/Users/markb/GitHub/core/runtime/runtimetest/test-response.html) -> [type:string] [url:c:\Users\markb\GitHub\core\runtime\runtimetest\test-response.html]
	//test: FileName(file:///c:/Users/markb/GitHub/core/runtime/runtimetest/test-response.html) -> [type:*url.URL] [url:c:\Users\markb\GitHub\core\runtime\runtimetest\test-response.html]
...
func Example_ReadFile() {
	...
	//Output:
	//test: ReadFile(file://[cwd]/runtimetest/test-response.html) -> [err:<nil>] [buf:188]
	//test: ReadFile(file:///c:/Users/markb/GitHub/core/runtime/runtimetest/test-response.html) -> [err:<nil>] [buf:188]
