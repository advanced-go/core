...
func Example_FileNameError() {
	...
	//test: FileName(file://[cwd]/uritest/html-response.txt) -> [type:*http.Request] [url:error: invalid URL type: *http.Request]
...
func Example_FileName() {
	...
	//test: FileName(file://[cwd]/uritest/html-response.txt) -> [type:string] [url:C:\Users\markb\GitHub\core\uri\uritest\html-response.txt]
	//test: FileName(file://[cwd]/uritest/html-response.txt) -> [type:*url.URL] [url:C:\Users\markb\GitHub\core\uri\uritest\html-response.txt]
	//test: FileName(file:///c:/Users/markb/GitHub/core/uri/uritest/html-response.txt) -> [type:string] [url:c:\Users\markb\GitHub\core\uri\uritest\html-response.txt]
	//test: FileName(file:///c:/Users/markb/GitHub/core/uri/uritest/html-response.txt) -> [type:*url.URL] [url:c:\Users\markb\GitHub\core\uri\uritest\html-response.txt]
